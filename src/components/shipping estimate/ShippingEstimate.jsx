...
export default function ShippingEstimate() {
  ...
  // const estimate = finalvalflo*freight.Roefreight + origintotal*freight.roe_origin_currency + destationTotal*freight.roe_des_currency;
  ...
  const apihit = () => {
    ...
    // formdata.append("des_currency", destation.des_currency ?? "");
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.success === true) {
          //   navigate("/Admin/shipping-estimate-list");
        }
      })
      .catch((error) => {
