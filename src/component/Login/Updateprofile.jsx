...
export default function UpdateProfile() {
    ...
    return (
        <>
            ...
            <div className="profileSec pt80">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="d-flex align-self-center h-100 justify-content-center">
                                <div className="profileFrontImg">
                                    <img src={`${process.env.REACT_APP_BASE_URL_image}${userData.profile}`} alt="Selected" style={{ maxWidth: '100%' }} />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="row">
                                    <div className="col">
                                        ...
                                        <input type="text" name='cellphone' value={userData?.cellphone} onChange={handleChange} className="form-control" />
                                    </div>
                                    <div className="col">
                                        <label htmlFor=""> Telephone</label>
                                        <input type="text" name='telephone' value={userData?.telephone} onChange={handleChange} className="form-control" />
                                    </div>
                                </div>
