...
import air2 from "../../../assestss/supportImg.webp";
...
export default function ComplianceSupportServices() {
  ...
  return (
    <div>
      ...
      <section
        className=" bannerBg"
        style={{ backgroundImage: `url(${compleImg})` }}
      >
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              <h5>
                Compliance Support Services are the cornerstone of seamless
              ...
              <div data-aos="fade-right" className="aos-init aos-animate">
                <div className="digitalTrusted pe25">
                  ...
                  <p className="paraSafe mt-4">
                    Asia Direct - Africa’s Compliance Support Services are the
                    cornerstone of seamless shipping and logistics operations.
                    We specialize in navigating the complex landscape of
                    permits, licenses, and regulatory compliance, ensuring your
      ...
      <section className="whyChooseAir pb50">
        <div className="container">
          <div className="row">
            <h2>Why Asia Direct - Africa for Compliance Support?</h2>
          </div>
          <div className="row ">
            <div className="parentWhyChoose">
              ...
              <div className="contetnPlain">
                ...
                <p>
                  {" "}
                  Our team of experts provides unparalleled support in obtaining
                  the necessary permits and licenses, tailored to your specific
            ...
            <div className="parentWhyChoose">
              ...
              <div className="contetnPlain">
                ...
                <p>
                  We act as your advocate, liaising with regulatory departments
                  to ensure all your shipping requirements are met without any
                  hitches
                </p>
              </div>
            </div>
            <div className="parentWhyChoose">
              ...
              <div className="contetnPlain">
                ...
                <p>
                  Our services are designed to integrate effortlessly with your
                  existing operations, providing a streamlined approach to
          ...
          <div className="row mt-4">
            <div className="contetnPlain">
              ...
              <p className="mt-2">
                {" "}
                With Asia Direct - Africa, you gain a partner that's dedicated
                to your business's compliance and success.
              </p>
            </div>
          <div>
                ...
                <div className="container">
                    ...
                    <div className=" row pt50">
                        <div className="col-lg-12">
                            ...
                            <p className="mt-3">
                                At Asia Direct - Africa, we’re more than just a warehousing provider; we’re your partner in growth
                            </p>
                        </div>
                    </div>
                </div>
