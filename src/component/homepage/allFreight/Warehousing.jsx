...
const Warehousing = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="bannerBg" style={{backgroundImage:`url(${wareImg})`}}>
              ...
              <div data-aos="fade-right" className="aos-init aos-animate">
                <div className="digitalTrusted pe25">
                  ...
                  <p className="paraSafe mt-4">
                    ...
                    seamlessly with your supply chain
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row ">
            <div className="parentWhyChoose">
              ...
              <div className="contetnPlain">
                ...
                <p>
                  {" "}
                  Our strategically located to ensure easy access and swift
                  distribution across South Africa and the SADC regions
                </p>
              </div>
            </div>
            <div className="parentWhyChoose">
              ...
              <div className="contetnPlain">
                ...
                <p>
                  {" "}
                  We prioritize the safety of your goods with high-security
                  measures, including 24/7 surveillance and controlled access.
                </p>
              </div>
            </div>
            <div className="parentWhyChoose">
              ...
              <div className="contetnPlain">
                ...
                <p>
                  {" "}
                  Whether you need short-term or long-term storage, our flexible
                  solutions can accommodate any volume of goods{" "}
                </p>
              </div>
            </div>
            <div className="parentWhyChoose">
              ...
              <div className="contetnPlain">
                ...
                <p>
                  {" "}
                  Our warehousing is just one part of a comprehensive suite of
                  logistics services, including transportation, customs
                  clearing, and compliance support.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-4">
              <div className="cardFright">
                ...
                <p className="paraSafe">
                  ...
                  real-time, ensuring accuracy and transparency
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="cardFright">
                ...
                <p className="paraSafe">
                  ...
                  a range of services to enhance your warehousing experience
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="cardFright">
                ...
                <p className="paraSafe">
                  ...
                  practices in our warehousing operations to minimize
